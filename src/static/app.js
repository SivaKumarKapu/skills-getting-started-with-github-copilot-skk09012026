document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      // Clear loading message and previous options to avoid stale/duplicate entries
          ...
          ? details.participants
              .map((email) => `
                <li class="participant-item">
                  ...
                  <button type="button" class="delete-btn" data-activity="${name}" data-email="${email}" aria-label="Remove ${email} from ${name}">
                    ✕
                  </button>
                </li>
              `)
